...
| --- | --- | --- | --- | --- |
| [0 — Foundations](phase-0-foundations.md) | Daemon starts, CLI talks to it, state persists | T1–T11 | 10 / 14 | **M0** `mix status` prints a healthy daemon on all three OSes in CI |
...
Phase 0, at **T8** — the JSON-RPC server over the transport T7 landed. Everything through T7 is
done; T8–T11 close out the milestone.
