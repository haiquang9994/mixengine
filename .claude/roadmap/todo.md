...
| [7 — Efficiency](phase-7-efficiency.md) | Deliver the promise that idle costs nothing | T68–T73 | 2 / 8 | **M7** 30 idle minutes leaves only the daemon and the web server |
